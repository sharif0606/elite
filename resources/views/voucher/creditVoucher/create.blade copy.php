            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" enctype="multipart/form-data" method="post" action="{{route('credit_voucher.store')}}">
                                @csrf
                                <div class="row">
                                            ...
                                            <tr>
                                                ...
                                                <td style='text-align:left;'>
                                                    <div style='width:100%;position:relative;'>
                                                        ...
                                                        <input type='hidden' class='table_name' name='table_name[]' value='sub_heads'>
                                                        <input type='hidden' class='table_id' name='table_id[]' value='3'>
                                                </td>
                                                <td style='text-align:left;'>
