        ...
        <table style="width: 100%; margin-bottom: .5rem;">
            <thead>
                <tr>
                    ...
                    <td style="text-align: left; width: 35%;">{{$dvoucher->pay_name}}</td>
                ...
                <tr>
                    ...
                    <td colspan="2" style="text-align: left;">{{$dvoucher->purpose}}</td>
                    <th >Account:</th>
                ...
                <tbody style="height: 300px;">
                    ...
                    @if ($bk->debit != 0)
                        <tr style="vertical-align: top; height: 0;">
                            ...
                            <th class="tbl_table_border_right" style="text-align: right;">{{money_format($bk->debit)}}</th>
