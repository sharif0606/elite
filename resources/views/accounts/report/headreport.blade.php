...
<section id="multiple-column-form">
	<div class="row match-height">
		<div class="col-12">
			<div class="card">
				<div class="text-end">
					<a href="#" class="no_print float-end" title="print" id="addCompanyDescription" onclick="printReport('result_show')"><svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 16 16">
							<g fill="currentColor">
							...
							<div class="row">
								<div class="col-sm-4">
									<div class="form-group">
										<label for="accDate">Acc Head</label><!--choices-->
