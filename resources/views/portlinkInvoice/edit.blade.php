        ...
        <div class="col-12">
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                        <form method="post" action="{{route('portlinkInvoice.update',[encryptor('encrypt',$inv->id),'role' =>currentUser()])}}" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                            <div class="row p-2">
                                <div class="col-lg-4 mt-2">
                                    <label for=""><b>Customer Name</b></label>
                                    <input type="text" class="form-control" value="{{$inv->customer?->name}}" readonly>
                                </div>
                            ...
                            <div class="row mt-5 table-responsive-sm">
                                <table class="table table-bordered" width="100%" cellspacing="0">
                                    ...
                                    <tbody class="show_invoice_data">
                                        @foreach ($invPortDetail as $invd)
                                            <tr style="text-align: center;">
                                                <td>{{++$loop->index}}</td>
                                                <td>{{$invd->jobpost?->name}}
                                                    <input class="" type="hidden" name="job_post_id[]" value="{{$invd->job_post_id}}">
                                                </td>
                                                <td>{{$invd->rate}}
                                                    <input class="form-control input_css rate_c text-center" type="hidden" name="rate[]" value="{{$invd->rate}}" readonly>
                                                </td>
                                                <td>{{$invd->commission}}
                                                    <input class="form-control input_css commission text-center" type="hidden" name="commission[]" value="{{$invd->commission}}" readonly>
                                                </td>
                                                <td>{{$invd->commission + $invd->rate}}
                                                    <input class="form-control input_css rate_with_commission text-center" type="hidden" name="rate_with_commission[]" value="{{$invd->commission + $invd->rate}}" readonly>
                                                </td>
                                                <td>{{$invd->employee_qty}}
                                                    <input class="form-control input_css employee_qty_c text-center" type="hidden" name="employee_qty[]" value="{{$invd->employee_qty}}" readonly>
                                                </td>
                                                <td>
                                                    ...
                                                    <input type="hidden" name="actual_warking_day[]" value="">
                                                    <input class="" type="hidden" name="st_date[]" value="{{$invd->st_date}}">
                                                    <input class="" type="hidden" name="ed_date[]" value="{{$invd->ed_date}}">
                                                    <input class="form-control input_css divide_by text-center" type="hidden" name="divide_by[]" value="{{$invd->divide_by}}">
                                                    <input class="type_houre" type="hidden" name="type_houre[]" value="{{$invd->type_houre}}">
                                                </td>
                                                <td>
                                                    <input class="form-control text-center input_css net_salary_amount" type="text" name="net_salary_amount[]" value="{{$invd->net_salary_amount}}" readonly>
                                                </td>
                                                <td>
                                                    <input class="form-control text-center input_css net_commission_amount" type="text" name="net_commission_amount[]" value="{{$invd->net_commission_amount}}" readonly>
                                                </td>
                                                <td>
                                                    <input class="form-control text-center input_css total_amounts" type="text" name="total_amounts[]" value="{{$invd->total_amounts}}" readonly>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                    <tfoot>
                                        <tr style="text-align: center;">
                                            ...
                                            <td width="8%"></td>
                                            <td><input type="text" class="form-control text-center sub_total_salary" name="sub_salary_total" value="{{$invPort->sub_amount}}" readonly></td>
                                            <td><input type="text" class="form-control text-center sub_total_commission" name="sub_commission_total" value="{{$invPort->sub_commission_amount}}" readonly></td>
                                            <td>
                                                <input readonly type="text" class="form-control sub_total_amount text-center" name="sub_total_amount" value="{{$invPort->sub_total_amount}}" value="">
                                            </td>
                                        </tr>
                                        <tr id="repeater_less" style="text-align: center;">
                                            @foreach ($less as $ls)
                                                <tr style="text-align: center;">
                                                    ...
                                                    <td colspan="3">
                                                        <textarea name="less_description[]" class="form-control text-center" rows="4">
                                                            @if ($ls->less_description != '')
                                                                {{$ls->less_description}}
                                                            @else
                                                                Less: duty absent of security Supervisor from
                                                            @endif
                                                        </textarea>
                                                    </td>
                                                    <td><input class="form-control text-center deduct_rate" onkeyup="reCalcultateInvoice(this)" type="text" placeholder="rate" name="less_rate[]" value="{{$ls->less_rate}}"></td>
                                                    <td><input class="form-control text-center deduct_commission_rate" onkeyup="reCalcultateInvoice(this)" type="text" placeholder="commission" name="less_commission[]" value="{{$ls->less_commission}}"></td>
                                                    <td><input class="form-control text-center deduct_hour" onkeyup="reCalcultateInvoice(this)" type="text" placeholder="duty" name="add_hour[]" value="{{$ls->count_hour}}"></td>
                                                    <td><input class="form-control text-center less_salary" type="text" name="net_less[]" value="{{$ls->net_less}}" readonly></td>
                                                    <td><input class="form-control text-center less_commission" type="text" name="commission_less[]" value="{{$ls->commission_less}}" readonly></td>
                                                    <td><input class="form-control text-center less_total" type="text" name="total_less[]" value="{{$ls->total_less}}" readonly></td>
                                                </tr>
                                            @endforeach
                                        </tr>
                                        <tr id="supervisor" style="text-align: center;">
                                            @foreach ($supDeduct as $sd)
                                                <tr style="text-align: center;">
                                                    <td><span onClick='removeIncressRowData(this);' class="add-row text-danger"><i class="bi bi-trash"></i></span></td>
                                                    <td colspan="3">
                                                        <textarea name="supervisor_deduction_description[]" class="form-control text-center" rows="4">
                                                            @if ($sd->deduction_description != '')
                                                                {{$sd->deduction_description}}
                                                            @else
                                                                Deduction: hours Supervisor duty deducted by post authority due to negligence during duty hours from
                                                            @endif
                                                        </textarea>
                                                    </td>
                                                    <td><input class="form-control text-center deduct_rate" onkeyup="reCalcultateInvoice(this)" type="text" placeholder="rate" name="deduct_sup_rate[]" value="{{$sd->deduct_sup_rate}}"></td>
                                                    <td><input class="form-control text-center deduct_commission_rate" onkeyup="reCalcultateInvoice(this)" type="text" placeholder="commission" name="deduct_sup_commission[]" value="{{$sd->deduct_sup_commission}}"></td>
                                                    <td><input class="form-control text-center deduct_hour" onkeyup="reCalcultateInvoice(this)" type="text" placeholder="hour" name="hour_supervisor[]" value="{{$sd->count_hour}}"></td>
                                                    <td><input class="form-control text-center deduct_salary" type="text" name="supervisor_rate_amount[]" value="{{$sd->net_deduction}}" readonly></td>
                                                    <td><input class="form-control text-center deduct_commission" type="text" name="supervisor_comission_amount[]" value="{{$sd->commission_deduction}}" readonly></td>
                                                    <td><input class="form-control text-center deduct_total" type="text" name="supervisor_amount[]" value="{{$sd->total_deduction}}" readonly></td>
                                                </tr>
                                            @endforeach
                                        </tr>
                                        <tr id="guard" style="text-align: center;">
                                            @foreach ($guardDeduct as $gd)
                                                <tr style="text-align: center;">
                                                    <td><span onClick='removeIncressRowData(this);' class="add-row text-danger"><i class="bi bi-trash"></i></span></td>
                                                    <td colspan="3">
                                                        <textarea name="guard_deduction_description[]" class="form-control text-center" rows="4">
                                                            @if ($gd->deduction_description != '')
                                                                {{$gd->deduction_description}}
                                                            @else
                                                                Deduction: hours guard duty deducted by post authority due to negligence during duty hours from
                                                            @endif
                                                        </textarea>
                                                    </td>
                                                    <td><input class="form-control text-center deduct_rate" onkeyup="reCalcultateInvoice(this)" type="text" placeholder="rate" name="deduct_guard_rate[]" value="{{$gd->deduct_guard_rate}}"></td>
                                                    <td><input class="form-control text-center deduct_commission_rate" onkeyup="reCalcultateInvoice(this)" type="text" placeholder="commission" name="deduct_guard_commission[]" value="{{$gd->deduct_guard_commission}}"></td>
                                                    <td><input class="form-control text-center deduct_hour" onkeyup="reCalcultateInvoice(this)" type="text" placeholder="hour" name="hour_guard[]" value="{{$gd->count_hour}}"></td>
                                                    <td><input class="form-control text-center deduct_salary" type="text" name="guard_rate_amount[]" value="{{$gd->net_deduction}}" readonly></td>
                                                    <td><input class="form-control text-center deduct_commission" type="text" name="guard_comission_amount[]" value="{{$gd->commission_deduction}}" readonly></td>
                                                    <td><input class="form-control text-center deduct_total" type="text" name="guard_amount[]" value="{{$gd->total_deduction}}" readonly></td>
                                                </tr>
                                            @endforeach
                                        </tr>
                                        <tr style="text-align: end;">
                                            ...
                                            <td></td>
                                            <td><input type="text" class="form-control text-center net_salary_rate_total" value="{{$invPort->net_amount}}" readonly></td>
                                            <td><input type="text" class="form-control text-center net_commission_rate_total" value="{{$invPort->net_commission}}" readonly></td>
                                            <td>
                                                <input type="text" class="form-control text-center net_salary_total" name="total_tk" value="{{$invPort->net_total_tk}}" readonly>
                                            </td>
                                        </tr>
                                        <tr style="text-align: end;">
                                            <td></td>
                                            <th colspan="5">Vat (<span class="vat_percent">{{$inv->vat}}</span> %)</th>
                                            <td></td>
                                            <td></td>
                                            <td></td>
                                            <td><input type="text" class="form-control text-center vat_taka" name="vat_taka" value="{{$invPort->vat_taka}}" readonly></td>
                                        </tr>
                                        <tr style="text-align: end;">
                                            <td></td>
                                            <th colspan="5">Grand Total</th>
                                            <td></td>
                                            <td><input type="text" class="form-control text-center net_salary_rate_total" name="net_salary_rate" value="{{$invPort->net_amount}}" readonly></td>
                                            <td><input type="text" class="form-control text-center net_commission_rate_total" name="net_commission_rate" value="{{$invPort->net_commission}}" readonly></td>
                                            <td><input readonly type="text" class="form-control text-center grand_total" name="grand_total" value="{{$invPort->grand_total}}"></td>
                                        </tr>
                                    </tfoot>
                                </table>
                            </div>
