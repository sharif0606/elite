                        ...
                        <form method="post" action="{{route('islamiBankEmpAssign.update', encrypt($islamiBankEmpAssign->id))}}" enctype="multipart/form-data">
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-lg-4 mt-2">
                                    ...
                                    <select class="form-select atm_id" id="atm_id" name="atm_id">
                                        ...
                                        @forelse ($atms as $a)
                                        <option value="{{ $a->id }}" @selected($islamiBankEmpAssign->atm_id == $a->id)>{{ $a->atm }}</option>
                                        @empty
                                        @endforelse
                                    </select>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 mt-2">
                                    ...
                                    <input required class="form-control end_date" type="date" name="end_date" value="{{ $islamiBankEmpAssign->end_date }}">
                                </div> --}}
                            </div>
                            <!-- table bordered -->
                            <div class="row p-2 mt-4">
                                <div class="table-responsive">
                                    <table class="table table-bordered mb-0 table-striped">
                                        ...
                                        <tbody id="empassign">
                                            @if ($islamiBankEmpAssign->details)
                                            @foreach ($islamiBankEmpAssign->details as $d)
                                            <tr>
                                                <td>1</td>
                                                <td>
                                                    <select class="form-select employee_id select2" id="employee_id" name="employee_id[]" onchange="getEmployees(this)">
                                                     ...
                                                     <input readonly class="form-control duty_rate" type="hidden" name="duty_rate[]" value="{{ $d->duty_rate }}" placeholder="Duty Rate">
                                                ...
                                                <td>
                                                    <select name="shift[]" id="shift" class="form-select" required>
                                                        ...
                                                        <option value="1" {{ $d->shift == 1 ? 'selected' : '' }}>A-Shift</option>
                                                        <option value="2" {{ $d->shift == 2 ? 'selected' : '' }}>B-Shift</option>
                                                        <option value="3" {{ $d->shift == 3 ? 'selected' : '' }}>C-Shift</option>
                                                    </select>
                                                </td>
                                                <td><input required onkeyup="salaryCalculate(this); dutyCount();" class="form-control not-hide duty" type="text" name="duty[]" value="{{ $d->duty }}" placeholder="Duty"></td>
