@extends('layout.app')
@section('pageTitle','Update Rate ')
@section('pageSubTitle','Edit Rate ')
@push('styles')
...
<div class="col-12 p-3">
    <div class="border">
        <div class="p-3">
            <form class="form" method="post" action="{{route('customerRate.update',[encryptor('encrypt',$crate->id),'role' =>currentUser()])}}" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <select class="form-select" id="job_post_id" name="job_post_id">
                                ...
                                <option value="{{ $job->id }}" {{ $job->id==$crate->job_post_id?'selected':'' }}>{{ $job->name }}</option>
                                @empty
                                @endforelse
                            </select>
                        </div>
