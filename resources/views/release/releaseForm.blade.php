...
<section class="section">
    <div class="row" id="table-bordered">
        <div class="col-12">
            <div class="card">
                <form method="post" action="{{route('relEmployee.store', ['role' =>currentUser()])}}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-3">
                            ...
                            <input type="text" class="form-control" name="appoint_customer_name" value="" required>
                        </div>
                        <div class="col-3">
