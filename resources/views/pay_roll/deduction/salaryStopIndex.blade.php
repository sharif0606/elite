@extends('layout.app')
@section('pageTitle',trans('Salary Stop List'))
        ...
        <div class="col-12">
            ...
            <div class="card">
                <div>
                    ...
                    <a class="float-end text-danger" href="{{route('salaryStopCreate')}}"><i class="bi bi-plus-square-fill" style="font-size: 1.5rem;"></i></a>
                </div>
