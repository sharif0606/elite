@extends('layout.app')
@section('pageTitle',trans('Deduction Jacket List'))
        ...
        <div class="col-12">
            ...
            <div class="card">
                <div>
                    ...
                    <a class="float-end text-danger" href="{{route('deduction_asign.deductionCreate',['deduction_id' => 5])}}"><i class="bi bi-plus-square-fill" style="font-size: 1.5rem;"></i></a>
                </div>
