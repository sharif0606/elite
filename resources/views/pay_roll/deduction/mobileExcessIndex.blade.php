@extends('layout.app')
@section('pageTitle',trans('Deduction Mobile Excess List'))
        ...
        <div class="col-12">
            ...
            <div class="card">
                <div>
                    ...
                    <a class="float-end text-danger" href="{{route('deduction_asign.deductionCreate',['deduction_id' => 15])}}"><i class="bi bi-plus-square-fill" style="font-size: 1.5rem;"></i></a>
                </div>
                    ...
                    <table class="table table-bordered mb-0">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">{{__('Moibile Excess')}}</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$p->excess_mobile}}</td>
                                <td>{{$p->excess_mobile_rmk}}</td>
                                <td>
