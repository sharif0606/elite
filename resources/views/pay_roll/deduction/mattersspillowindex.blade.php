@extends('layout.app')
@section('pageTitle',trans('Deduction Matterss Pillow Cost List'))
        ...
        <div class="col-12">
            ...
            <div class="card">
                <div>
                    ...
                    <a class="float-end text-danger" href="{{route('deduction_asign.deductionCreate',['deduction_id' => 9])}}"><i class="bi bi-plus-square-fill" style="font-size: 1.5rem;"></i></a>
                </div>
                    ...
                    <table class="table table-bordered mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$p->matterss_pillowCost_rmk}}</td>
                                <td>
