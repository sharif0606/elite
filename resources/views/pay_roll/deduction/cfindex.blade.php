@extends('layout.app')
@section('pageTitle',trans('Deduction Cf List'))
        ...
        <div class="col-12">
            ...
            <div class="card">
                <div>
                    ...
                    <a class="float-end text-danger" href="{{route('deductionCreate',['deduction_asign.deduction_id' => 7])}}"><i class="bi bi-plus-square-fill" style="font-size: 1.5rem;"></i></a>
                </div>
