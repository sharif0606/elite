@extends('layout.app')
@section('pageTitle',trans('Deduction Absent List'))
...
<section class="section">
    <div class="row" id="table-bordered">
        <div class="col-12">
            ...
            <div class="card">
                <div>
                    <a class="float-end text-danger" href="{{route('deductionCreate',['deduction_id' => 17])}}"><i class="bi bi-plus-square-fill" style="font-size: 1.5rem;"></i></a>
                </div>
