        ...
        <div class="col-12">
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                        <form method="post" action="{{route('salarysheet.salarySheetThreeUpdate',[encryptor('encrypt',$salary->id),'role' =>currentUser()])}}">
                            @csrf
                            @method('POST')
                                    ...
                                    <table class="table table-bordered mb-0">
                                        <thead class="">
                                            <tr class="text-center" id="">
                                                ...
                                                <th scope="col" rowspan="2">{{__('Bank_name')}}</th>
                                        ...
                                        <tbody class="salarySheet">
                                            ...
                                            @php
                                                if($old_emp == $d->employee?->admission_id_no){
                                                    $foodAllownce = '<input class="form-control" type="hidden" name="food_allownce[]" value="0">';
                                                    $absentCon='<input class="form-control" type="hidden" name="deduction_absent[]" value="0">';
                                                    $vacantCon='<input class="form-control" type="hidden" name="deduction_vacant[]" value="0">';
                                                    $hrentCon='<input class="form-control" type="hidden" name="deduction_h_rent[]" value="0">';
                                                    $pfCon='<input class="form-control" type="hidden" name="deduction_p_f[]" value="0">';
                                                    $advCon='<input class="form-control" type="hidden" name="deduction_adv[]" value="0">';
                                                    $stmCon='<input class="form-control" type="hidden" name="deduction_stm[]" value="0">';
                                                    $deTotalCon='<input class="form-control" type="hidden" name="deduction_total[]" value="0">';
                                                    $netSalaryCon='<input class="form-control" type="hidden" name="net_wages[]" value="0" >';
                                                } else {
                                                    $foodAllownce = '<input onkeyup="reCalcultateSalary(this)" style="width:100px;" class="form-control food_allownce" type="text" name="food_allownce[]" value="'.$d->food_allownce .'">';
                                                    $absentCon='<input onkeyup="reCalcultateSalary(this)" style="width:100px;" class="form-control deduction_absent" type="text" name="deduction_absent[]" value="'.$d->deduction_absent.'" readonly>';
                                                    $vacantCon='<input onkeyup="reCalcultateSalary(this)" style="width:100px;" class="form-control deduction_vacant" type="text" name="deduction_vacant[]" value="'.$d->deduction_vacant.'" readonly>';
                                                    $hrentCon='<input onkeyup="reCalcultateSalary(this)" style="width:100px;" class="form-control deduction_h_rent" type="text" name="deduction_h_rent[]" value="'.$d->deduction_hr.'">';
                                                    $pfCon='<input onkeyup="reCalcultateSalary(this)" style="width:100px;" class="form-control deduction_p_f" type="text" name="deduction_p_f[]" value="'.$d->deduction_p_f.'" readonly>';
                                                    $advCon='<input onkeyup="reCalcultateSalary(this)" style="width:100px;" class="form-control deduction_adv" type="text" name="deduction_adv[]" value="'.$d->deduction_adv.'" readonly>';
                                                    $stmCon='<input onkeyup="reCalcultateSalary(this)" style="width:100px;" class="form-control deduction_stm" type="text" name="deduction_stm[]" value="'.$d->deduction_revenue_stamp.'" readonly>';
                                                    $deTotalCon='<input style="width:100px;" class="form-control deduction_total" type="text" name="deduction_total[]" value="" value="'.$d->deduction_total.'"  readonly>';
                                                    $netSalaryCon='<input style="width:100px;" class="form-control net_wages" type="text" name="net_wages[]" value="'.$d->net_salary.'"  readonly>';
                                                }
                                            @endphp
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="fixed-3">
                                                        <input style="width:150px;" class="form-control" type="text" value="{{$d->position?->name}}" placeholder="Rank">
                                                    ...
                                                    <td>
                                                        <input onkeyup="reCalcultateSalary(this)" style="width:100px;" class="form-control house_rent" type="text" name="house_rent[]" value="{{$d->house_rent}}" placeholder="House rent (50%)">
                                                    </td>
                                                    <td>
                                                        <input onkeyup="reCalcultateSalary(this)" style="width:100px;" class="form-control medical" type="text" name="medical[]" value="{{$d->medical}}" placeholder="Medical">
                                                    </td>
                                                    <td>
                                                        <input onkeyup="reCalcultateSalary(this)" style="width:100px;" class="form-control trans_conve" type="text" name="trans_conve[]" value="{{$d->trans_conve}}" placeholder="Trans. Conve.">
                                                    </td>
                                                    <td>{!! $foodAllownce !!}</td>
                                                    <td>
                                                        <input style="width:100px;" class="form-control gross_wages" type="text" name="gross_wages[]" value="{{$d->gross_wages}}" placeholder="Gross Wages" readonly>
                                                    </td>
                                                    <td>{{(int)$d->total_workingday}}
                                                        <input onkeyup="reCalcultateSalary(this)" style="width:100px;" class="form-control total_workingDay" type="hidden" name="total_workingDay[]" value="{{$d->total_workingday}}" placeholder="Total Working Days" readonly>
                                                    </td>
                                                    <td>{{(int)$d->present_day}}
                                                        <input onkeyup="reCalcultateSalary(this)" style="width:100px;" class="form-control present_day" type="hidden" name="present_day[]" value="{{$d->present_day}}" placeholder="Pre. Days">
                                                    </td>
                                                    <td>
                                                        <input onkeyup="reCalcultateSalary(this)" style="width:100px;" class="form-control absent" type="text" name="absent[]" value="{{$d->absent}}" placeholder="Absent">
                                                    </td>
                                                    <td>
                                                        <input onkeyup="reCalcultateSalary(this)" style="width:100px;" class="form-control vacant" type="text" name="vacant[]" value="{{$d->vacant}}" placeholder="Vacant">
                                                    </td>
                                                    <td>
                                                        <input onkeyup="reCalcultateSalary(this)" style="width:100px;" class="form-control holiday_festival" type="text" name="holiday_festival[]" value="{{$d->holiday_festival}}" placeholder="Holiday/ festival">
                                                    </td>
                                                    <td>
                                                        <input onkeyup="reCalcultateSalary(this)" style="width:100px;" class="form-control leave_cl" type="text" name="leave_cl[]" value="{{$d->leave_cl}}" placeholder="Leave CL">
                                                    </td>
                                                    <td>
                                                        <input onkeyup="reCalcultateSalary(this)" style="width:100px;" class="form-control leave_sl" type="text" name="leave_sl[]" value="{{$d->leave_sl}}" placeholder="Leave SL">
                                                    </td>
                                                    <td>
                                                        <input onkeyup="reCalcultateSalary(this)" style="width:100px;" class="form-control leave_el" type="text" name="leave_el[]" value="{{$d->leave_el}}" placeholder="Leave EL">
                                                    </td>
                                                    <td>{!! $absentCon !!}</td>
                                                    <td>{!! $vacantCon !!}</td>
                                                    <td>{!! $hrentCon !!}</td>
                                                    ...
                                                    <td>{!! $netSalaryCon !!}</td>
                                                    <td>
                                                        <input onkeyup="reCalcultateSalary(this)" style="width:100px;" class="form-control ot_hour" type="text" name="ot_hour[]" value="{{$d->ot_qty}}" placeholder="OT hour">
                                                    </td>
                                                    <td>
                                                        <input onkeyup="reCalcultateSalary(this)" style="width:100px;" class="form-control ot_rate_basicDuble" type="text" name="ot_rate_basicDuble[]" value="{{$d->ot_rate_basicDuble}}" placeholder="OT rate(Basic*2)">
                                                    </td>
                                                    <td>
                                                        <input style="width:100px;" class="form-control ot_amt" type="text" name="ot_amt[]" value="{{$d->ot_amount}}" placeholder="OT Amt." readonly>
                                                    </td>
                                                    <td>
                                                        <input style="width:100px;" class="form-control total_payable" type="text" name="total_payable[]" value="{{$d->total_payable}}" placeholder="Total Payable" readonly>
                                                    </td>
                                                    <td>
                                                        <input style="width:100px;" class="form-control signature" type="text" name="signature[]" value="{{$d->sing_of_ind}}" placeholder="Signature">
                                                    </td>
                ...
                let selectElement = $('.salarySheet');
                    ...
                    $.each(salary_data, function(index, value) {
                        ...
                        if(old_emp == value.admission_id_no){
                            ...
                            var food=`<input onkeyup="reCalcultateSalary(this)" style="width:100px;" class="form-control food_allownce" type="text" name="food_allownce[]" value="${foodAllowance}">`;
                        ...
                        selectElement.append(
                            `<tr>
                                ...
                                <td class="fixed-4"><input style="width:200px;" readonly class="form-control" type="text" value="${value.en_applicants_name}" placeholder="Name"></td>
