        ...
        <div class="col-12">
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                        <form method="post" action="{{route('salarysheet.salarySheetTwoUpdate',[encryptor('encrypt',$salary->id),'role' =>currentUser()])}}" enctype="multipart/form-data">
                            @csrf
                                        ...
                                        <tbody class="salarySheet">
                                            ...
                                            @php
                                                if($old_emp == $d->employee?->admission_id_no){
                                                    $mpcCon='<input style="width:100px;" class="form-control" type="text" name="deduction_matterss_pillowCost[]" value="" readonly>';
                                                    $tonicsimCon='<input style="width:100px;" class="form-control" type="text" name="deduction_tonic_sim[]" value="" readonly>';
                                                    $opcCon='<input style="width:100px;" class="form-control" type="text" name="deduction_over_paymentCut[]" value="" readonly>';
                                                    $fineCon='<input style="width:100px;" class="form-control" type="text" name="deduction_fine[]" value="0" v>';
                                                    $loonCon='<input style="width:100px;" class="form-control" type="text" name="deduction_loan[]" value="0" readonly>';
                                                    $longLoonCon='<input style="width:100px;" class="form-control" type="text" name="deduction_longLoan[]" value="0" readonly>';
                                                    $clothCon='<input style="width:100px;" class="form-control" type="text" name="deduction_cloth[]" value="0" readonly>';
                                                    $hrCon='<input style="width:100px;" class="form-control" type="text" name="deduction_hr[]" value="0" readonly>';
                                                    $jacketCon='<input style="width:100px;" class="form-control" type="text" name="deduction_jacket[]" value="0" readonly>';
                                                    $stmCon='<input style="width:100px;" class="form-control" type="text" name="deduction_stamp[]" value="0" readonly>';
                                                    $trainingCostCon='<input style="width:100px;" class="form-control" type="text" name="deduction_traningCost[]" value="0" readonly>';
                                                    $cfCon='<input style="width:100px;" class="form-control" type="text" name="deduction_c_f[]" value="0" readonly>';
                                                    $medicalCon='<input style="width:100px;" class="form-control" type="text" name="deduction_medical[]" value="0" readonly>';
                                                    $insCon='<input style="width:100px;" class="form-control" type="text" name="deduction_ins[]" value="0" readonly>';
                                                    $pfCon='<input style="width:100px;" class="form-control" type="text" name="deduction_p_f[]" value="0" readonly>';
                                                    $deTotalCon='<input style="width:100px;" class="form-control" type="text" name="deduction_total[]" value="0" readonly>';
                                                    
                                                } else {
                                                    $mpcCon='<input onkeyup="reCalcultateSalary(this)" style="width:100px;" class="form-control deduction_matterss_pillowCost" type="text" name="deduction_matterss_pillowCost[]" value="'.$d->deduction_matterss_pillowCost.'">';
                                                    $tonicsimCon='<input onkeyup="reCalcultateSalary(this)" style="width:100px;" class="form-control deduction_tonic_sim" type="text" name="deduction_tonic_sim[]" value="'.$d->deduction_tonic_sim.'" >';
                                                    $opcCon='<input onkeyup="reCalcultateSalary(this)" style="width:100px;" class="form-control deduction_over_paymentCut" type="text" name="deduction_over_paymentCut[]" value="'.$d->deduction_over_paymentCut.'" >';
                                                    $fineCon='<input onkeyup="reCalcultateSalary(this)" style="width:100px;" class="form-control deduction_fine" type="text" name="deduction_fine[]" value="'.$d->deduction_fine.'">';
                                                    $loonCon='<input onkeyup="reCalcultateSalary(this)" style="width:100px;" class="form-control deduction_loan" type="text" name="deduction_loan[]" value="'.$d->deduction_loan.'" >';
                                                    $longLoonCon='<input onkeyup="reCalcultateSalary(this)" style="width:100px;" class="form-control deduction_longLoan" type="text" name="deduction_longLoan[]" value="'.$d->deduction_long_loan.'" >';
                                                    $clothCon='<input onkeyup="reCalcultateSalary(this)" style="width:100px;" class="form-control deduction_cloth" type="text" name="deduction_cloth[]" value="'.$d->deduction_cloth.'" >';
                                                    $hrCon='<input onkeyup="reCalcultateSalary(this)" style="width:100px;" class="form-control deduction_hr" type="text" name="deduction_hr[]" value="'.$d->deduction_hr.'" >';
                                                    $jacketCon='<input onkeyup="reCalcultateSalary(this)" style="width:100px;" class="form-control deduction_jacket" type="text" name="deduction_jacket[]" value="'.$d->deduction_jacket.'">';
                                                    $stmCon='<input onkeyup="reCalcultateSalary(this)" style="width:100px;" class="form-control deduction_stamp" type="text" name="deduction_stamp[]" value="'.$d->deduction_revenue_stamp.'">';
                                                    $trainingCostCon='<input onkeyup="reCalcultateSalary(this)" style="width:100px;" class="form-control deduction_traningcost" type="text" name="deduction_traningCost[]" value="'.$d->deduction_traningcost.'">';
                                                    $cfCon='<input onkeyup="reCalcultateSalary(this)" style="width:100px;" class="form-control deduction_c_f" type="text" name="deduction_c_f[]" value="'.$d->deduction_c_f.'">';
                                                    $medicalCon='<input onkeyup="reCalcultateSalary(this)" style="width:100px;" class="form-control deduction_medical" type="text" name="deduction_medical[]" value="'.$d->deduction_medical.'">';
                                                    $insCon='<input onkeyup="reCalcultateSalary(this)" style="width:100px;" class="form-control deduction_ins" type="text" name="deduction_ins[]" value="'.$d->deduction_ins.'" >';
                                                    $pfCon='<input onkeyup="reCalcultateSalary(this)" style="width:100px;" class="form-control deduction_p_f" type="text" name="deduction_p_f[]" value="'.$d->deduction_p_f.'" >';
                                                    $deTotalCon='<input onkeyup="reCalcultateSalary(this)" style="width:100px;" class="form-control deduction_total" type="text" name="deduction_total[]" value="'.$d->deduction_total.'">';
                                            ...
                                            @endphp
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="fixed-3"><input style="width:100px;" class="form-control joining_date" type="text" name="joining_date[]" value="{{$d->employee?->salary_joining_date}}" readonly></td>
                                                    <td class="fixed-4">
                                                    ...
                                                    <td>
                                                        <input onkeyup="reCalcultateSalary(this)" style="width:100px;" class="form-control payment_type" type="text" name="payment_type[]" value="{{$d->online_payment}}" placeholder="Payment Type">
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <input onkeyup="reCalcultateSalary(this)" style="width:100px;" readonly class="form-control duty_qty" type="text" name="duty_qty[]" value="{{$d->duty_qty}}" placeholder="Duty Rate">
                                                    </td>
                                                    <td>
                                                        <input onkeyup="reCalcultateSalary(this)" style="width:100px;" readonly class="form-control duty_amount" type="text" name="duty_amount[]" value="{{$d->duty_amount}}" placeholder="Duty Amount">
                                                    </td>
                                                    <td>
                                                        <input onkeyup="reCalcultateSalary(this)" style="width:100px;" class="form-control weekly_leave" type="text" name="weekly_leave[]" value="{{$d->weekly_leave}}" placeholder="Weekly Leave">
                                                    </td>
                                                    <td>
                                                        <input onkeyup="reCalcultateSalary(this)" style="width:100px;" readonly class="form-control ot_qty" type="text" name="ot_qty[]" value="{{$d->ot_qty}}" placeholder="Ot Qty">
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <input onkeyup="reCalcultateSalary(this)" style="width:100px;" readonly class="form-control ot_amount" type="text" name="ot_amount[]" value="{{$d->ot_amount}}" placeholder="Ot Amount">
                                                    </td>
                                                    <td>
                                                        <input onkeyup="reCalcultateSalary(this)" style="width:100px;" class="form-control ht_ribon_alice" type="text" name="ht_ribon_alice[]" value="{{$d->ht_ribon_alice}}" placeholder="HT/Ribon Alice">
                                                    </td>
                                                    <td>
                                                        <input onkeyup="reCalcultateSalary(this)" style="width:100px;" class="form-control gun_alice" type="text" name="gun_alice[]" value="{{$d->gun_alice}}" placeholder="Gun Alice">
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <input onkeyup="reCalcultateSalary(this)" style="width:100px;" class="form-control extra_alice" type="text" name="extra_alice[]" value="{{$d->extra_alice}}" placeholder="Extra Alice">
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <input onkeyup="reCalcultateSalary(this)" style="width:100px;" class="form-control bonus" type="text" name="bonus[]" value="{{$d->bonus}}" placeholder="Bonus">
                                                    </td>
                                                    <td>
                                                        <input onkeyup="reCalcultateSalary(this)" style="width:100px;" class="form-control donation" type="text" name="donation[]" value="{{$d->donation}}" placeholder="Donation">
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>{!! $deTotalCon !!}</td>
                                                    <td>
                                                        <input onkeyup="reCalcultateSalary(this)" style="width:100px;" class="form-control net_salary" type="text" name="net_salary[]" value="{{$d->net_salary}}">
                                                    </td>
                                                    <td>
                                                        <input onkeyup="reCalcultateSalary(this)" style="width:100px;" class="form-control signature" type="text" name="signature[]" value="{{$d->sing_of_ind}}" placeholder="Signature">
                                                    </td>
                                                    <td>
                                                        <input onkeyup="reCalcultateSalary(this)" style="width:100px;" class="form-control zone" type="text" name="zone[]" value="{{$d->zone}}" placeholder="Zone">
                                                    </td>
                    ...
                    $.each(salary_data, function(index, value) {
                        ...
                        selectElement.append(
                            `<tr>
                                ...
                                <td class="fixed-3"><input style="width:100px;" class="form-control joining_date" type="text" name="joining_date[]" value="${value.salary_joining_date}" readonly></td>
                                <td class="fixed-4">
                                ...
                                <td class="fixed-5"><input style="width:200px;" readonly class="form-control" type="text" value="${value.en_applicants_name}" placeholder="Name"></td>
                                ...
                                <td>
                                    <input onkeyup="reCalcultateSalary(this)" style="width:100px;" class="form-control net_salary" type="text" name="net_salary[]" value="${Math.round(netSalary)}">
                                </td>
                                <td>
