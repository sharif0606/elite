...
@section('content')
<div>
    <form method="get" action="{{route('salarysheet.employeeWiseSalary')}}">
        <div class="row">
            <div class="col-lg-2">
                            ...
                            <div class="table-responsive">
                                <table id="salaryTable" class="mb-0" style="width: 1800px !important;">
                                    ...
                                    <tbody class="salarySheet">
                                        ...
                                        @if($sheet->details->where('branch_id', $branch->id)->where('employee_id', request('employee_id'))->isNotEmpty())
