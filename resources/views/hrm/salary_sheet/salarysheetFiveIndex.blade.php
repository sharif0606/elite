    ...
    <div class="card">
        ...
        <div class="table-responsive">
            <table class="table table-bordered mb-0 table-striped">
                <a class="btn btn-sm btn-primary float-end my-2" href="{{route('salarysheet.salarySheetFive')}}"><i class="bi bi-plus-square"></i> Add New</a>
                <thead>
                ...
                <tbody>
                    ...
                    <tr class="text-center">
                        ...
                        <td>
                            ...
                            <a class="px-1" href="{{route('salarySheetFiveEdit',[encryptor('encrypt',$s->id),'role' =>currentUser()])}}">
