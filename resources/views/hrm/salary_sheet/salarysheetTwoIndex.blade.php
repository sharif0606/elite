@extends('layout.app')
@section('pageTitle','Salary Sheet Two List')
            ...
            <table class="table table-bordered mb-0 table-striped">
                ...
                <tbody>
                    ...
                    <tr class="text-center">
                        ...
                        <td>
                            <a href="{{route('salarysheet.salarySheetTwoShow',[encryptor('encrypt',$s->id)])}}">
                                <i class="bi bi-eye"></i>
                            </a>
                            <a class="px-1" href="{{route('salarySheetTwoEdit',[encryptor('encrypt',$s->id),'role' =>currentUser()])}}">
