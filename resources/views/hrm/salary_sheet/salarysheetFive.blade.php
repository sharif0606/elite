            ...
            success: function(salary_data) {
                ...
                if (salary_data) {
                    $.each(salary_data, function(index, value) {
                        ...
                        let grossAmoun = (value.grossAmount > 0) ? Number(value.grossAmount) : '0';
                        ...
                        if (!appliedDeductions[value.admission_id_no]) {
                            if (value.charge_status == 0) {
                                ...
                                if (value.cinsurance > 0 && value.pf_ins_med_food_status == 2)
                                    Insurance = (value.cinsurance > 0) ? value.cinsurance : '0';
                                else
                                    Insurance = (value.insurance > 0) ? value.insurance : '0';


                                if (value.cstamp > 0 && value.pf_ins_med_food_status == 2)
                            ...
                            if (new Date(Year, Month - 1, 1) >= sixMonthsLater && value.charge_status == 0) {
