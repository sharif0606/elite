                ...
                <div class="row p-3">
                    ...
                    <div style="page-break-inside: avoid;">
                        ...
                        <div>
                            ...
                            <p class="my-0">এলিট সিকিউরিটি সার্ভিসেস লিঃ-এ প্রশিক্ষণ পূর্ববর্তী থাকা, খাওয়া ও প্রশিক্ষণ খরচের ৫০% কোম্পানী বহন করবে এবং বাকি ৫০% খরচ বাবদ {{round($employees->bn_traning_cost+$employees->bn_remaining_cost)}} /- টাকা নির্ধারিত। আমি স্বজ্ঞানে, সুস্থ মস্তিস্কে হলফপূর্বক ঘোষণা করছি যে, প্রশিক্ষণ গ্রহণের পূর্বে আমি প্রশিক্ষণ ফি বাবদ @if($employees->bn_traning_cost > 0) {{round($employees->bn_traning_cost)}} @else <span>০-/</span> @endif -/ টাকা প্রশিক্ষণ ফি প্রদান করি। প্রশিক্ষণ ফি বাবদ বাকি @if($employees->bn_remaining_cost > 0) {{round($employees->bn_remaining_cost)}} @else <span>০-/</span> @endif -/- টাকা আমার মাসিক বেতন থেকে ছয় মাসে কর্তন করা হলে আমার কোনো প্রকার আপত্তি থাকবে না। প্রশিক্ষণ ফি প্রদানে ব্যাপারে আমার কোনো অভিযোগ/আপত্তি নেই।</p>
                        </div>
                        <table style="width: 100%;">
