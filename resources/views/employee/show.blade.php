    ...
    <div class="tab-content" id="pills-tabContent">
        ...
        <div class="tab-pane fade" id="step-6" role="tabpanel" aria-labelledby="step-6-tab">
            <div class="text-center m-2">
                ...
                {{-- <a href="#" class="no_print" title="print" onclick="downloadDivAsWord('result_show_six')"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="35" height="35" viewBox="0 0 48 48">
