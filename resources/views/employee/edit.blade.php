                        ...
                        <div class="form-group">
                            ...
                            <select name="bn_jobpost_id" class="select2 form-control @error('bn_jobpost_id') is-invalid @enderror" id="bn_jobpost_id">
                                ...
                                @forelse($jobposts as $d)
                                    ...
                                    @else
                                        <option value="{{$d->id}}" {{ $employees->bn_jobpost_id==$d->id?"selected":""}}> {{ $d->name}}</option>
                                    @endif
                                @empty
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-12">
                        <div class="form-group">
                            ...
                            <input type="number" id="bn_post_allowance" value="{{old('bn_post_allowance',$employees->bn_post_allowance)}}" class="form-control @error('bn_post_allowance') is-invalid @enderror" placeholder="পোস্ট এলাউন্স" name="bn_post_allowance">
                    ...
                    <div class="col-md-4 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" value="{{old('second_bank_name',$employees->second_bank_name)}}" class="form-control" placeholder="ব্যাংক নাম" name="second_bank_name">
                        </div>
                    </div>
                    <div class="col-md-4 col-12">
                        <div class="form-group">
                            <label for="bn_brance_name">ব্রাঞ্চ নাম (For Wasa)</label>
                            <input type="text" value="{{old('second_brance_name',$employees->second_brance_name)}}" class="form-control" placeholder="ব্রাঞ্চ নাম" name="second_brance_name">
                        </div>
                    </div>
                    <div class="col-md-4 col-12">
                        <div class="form-group">
                            <label for="bn_ac_no">একাউন্ট নং (For Wasa)</label>
                            <input type="text" value="{{old('second_ac_no',$employees->second_ac_no)}}" class="form-control" placeholder="একাউন্ট নম্বর" name="second_ac_no">
                        </div>
                    </div>
                    <div class="col-md-4 col-12">
                        <div class="form-group">
                            <label for="bn_ac_name">একাউন্ট নাম (For Wasa)</label>
                            <input type="text" value="{{old('second_ac_name',$employees->second_ac_name)}}" class="form-control" placeholder="একাউন্ট নাম" name="second_ac_name">
                        </div>
                    </div>
                    <div class="col-md-4 col-12">
                        <div class="form-group">
                    ...
                    <div class="col-md-4 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" value="{{old('remarks',$employees->remarks)}}" class="form-control" name="remarks">
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" id="en_parm_post_ofc" value="{{old('en_parm_post_ofc',$employees->en_parm_post_ofc)}}" class="form-control" placeholder="post office" name="en_parm_post_ofc">
                        </div>
                    </div>
                    <div class="col-md-4 col-12">
                        <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" id="en_pre_post_ofc" value="{{old('en_pre_post_ofc',$employees->en_pre_post_ofc)}}" class="form-control" placeholder="post office" name="en_pre_post_ofc">
                        </div>
                    </div>
                </div>
                <div class="row">
