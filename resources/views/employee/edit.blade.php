                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" id="en_applied_position" value="{{old('en_applied_position',$employees->en_applied_position)}}" class="form-control" placeholder="applied Post" name="en_applied_position">
                        </div>
                    </div>
                </div>
