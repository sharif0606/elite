...
<div class="col-12 p-3">
    <div class="border">
        <div class="p-3">
            <form class="form" method="post" action="{{route('security.store', [$employees->id,'role' =>currentUser()])}}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row">
                    <div class="col-md-4 col-12">
                        <div class="form-group">
                            ...
                            <select onchange="show_upazila(this.value)" name="bn_in_laws_district_id" class=" form-control js-example-basic-single" id="bn_in_laws_district_id">
                                ...
                                <option value="{{$d->id}}" {{ $security->bn_in_laws_district_id==$d->id?"selected":""}}> {{ $d->name_bn}}</option>
                                @empty
                    ...
                    <div class="col-md-4 col-12">
                        <div class="form-group">
                            ...
                            <select name="bn_in_laws_upazilla_id" class="form-control js-example-basic-single" id="bn_in_laws_upazilla_id">
                                ...
                                <option class="district district{{$d->district_id}}" value="{{$d->id}}" {{ $security->bn_in_laws_upazilla_id==$d->id?"selected":""}}> {{ $d->name_bn}}</option>
                                @empty
                    ...
                    <div class="col-md-4 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" id="bn_in_laws_village_name" value="{{old('bn_in_laws_village_name',$security->bn_in_laws_village_name)}}" class="form-control" placeholder="গ্রামের নাম" name="bn_in_laws_village_name">
                        </div>
                    </div>
                    <div class="col-md-4 col-12">
                        <div class="form-group">
                            <label for="bn_in_laws_post_office">ডাকঘর</label>
                            <input type="text" id="bn_in_laws_post_office" value="{{old('bn_in_laws_post_office',$security->bn_in_laws_post_office)}}" class="form-control" placeholder="ডাকঘর" name="bn_in_laws_post_office">
                        </div>
                    </div>
                </div>
                <div class="row gx-1">
                    <div class="col-md-4 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" id="bn_husband_profession" value="{{old('bn_husband_profession',$security->bn_husband_profession)}}" class="form-control" placeholder="" name="bn_husband_profession">
                        </div>
                    </div>
                    <div class="col-md-4 col-12">
                        <div class="form-group">
                            <label for="bn_father_profession">পিতার পেশা</label>
                            <input type="text" id="bn_father_profession" value="{{old('bn_father_profession',$security->bn_father_profession)}}" class="form-control" placeholder="" name="bn_father_profession">
                        </div>
                    </div>
                    {{--  <div class="col-md-4 col-12">
                        <div class="form-group">
                    ...
                    <div class="col-md-4 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" id="bn_landlord_name" value="{{old('bn_landlord_name',$security->bn_landlord_name)}}" class="form-control" placeholder="" name="bn_landlord_name">
                        </div>
                    </div>
                    <div class="col-md-4 col-12">
                        <div class="form-group">
                            <label for="bn_landlord_mobile_no">জমিদারের মোবাইল নম্বর</label>
                            <input type="text" id="bn_landlord_mobile_no" value="{{old('bn_landlord_mobile_no',$security->bn_landlord_mobile_no)}}" class="form-control" placeholder="" name="bn_landlord_mobile_no">
                        </div>
                    </div>
                    <div class="col-md-4 col-12">
                        <div class="form-group">
                            <label for="bn_living_dur">বর্তমান ঠিকানায় কতদিন যাবৎ বাস করছেন</label>
                            <input type="text" id="bn_living_dur" value="{{old('bn_living_dur',$security->bn_living_dur)}}" class="form-control" placeholder="" name="bn_living_dur">
                        </div>
                    </div>
                    <div class="col-md-4 col-12">
                        <div class="form-group">
                            <label for="bn_passport_no">পাসপোর্ট নং যদি থাকে</label>
                            <input type="text" id="bn_passport_no" value="{{old('bn_passport_no',$security->bn_passport_no)}}" class="form-control" placeholder="" name="bn_passport_no">
                        </div>
                    </div>
                    <div class="col-md-4 col-12">
                        <div class="form-group">
                            <label for="bn_old_office_name">পূর্বের কর্মস্থলের নাম কি</label>
                            <input type="text" id="bn_old_office_name" value="{{old('bn_old_office_name',$security->bn_old_office_name)}}" class="form-control" placeholder="" name="bn_old_office_name">
                        </div>
                    </div>
                    <div class="col-md-4 col-12">
                        <div class="form-group">
                            <label for="bn_old_office_address">পূর্বের কর্মস্থলের ঠিকানা</label>
                            <input type="text" id="bn_old_office_address" value="{{old('bn_old_office_address',$security->bn_old_office_address)}}" class="form-control" placeholder="" name="bn_old_office_address">
                        </div>
                    </div>
                    <div class="col-md-4 col-12">
                        <div class="form-group">
                            <label for="bn_resign_reason">পূর্বের কর্মস্থলের থেকে কাজ ছাড়ার কারণ কি</label>
                            <input type="text" id="bn_resign_reason" value="{{old('bn_resign_reason',$security->bn_resign_reason)}}" class="form-control" placeholder="" name="bn_resign_reason">
                        </div>
                    </div>
                    <div class="col-md-4 col-12">
                        <div class="form-group">
                            ...
                            <select id="bn_resign_letter_status" class="form-control" name="bn_resign_letter_status">
                                ...
                                <option value="1" {{ $security->bn_resign_letter_status=='1'?"selected":""}}>হা</option>
                                <option value="2" {{ $security->bn_resign_letter_status=='2'?"selected":""}}>না</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-4 col-12">
                        <div class="form-group">
                            ...
                            <select id="bn_service_book_status" class="form-control" name="bn_service_book_status">
                                <option value="">নির্বাচন করুন</option>
                                <option value="1" {{ $security->bn_service_book_status=='1'?"selected":""}}>হা</option>
                                <option value="2" {{ $security->bn_service_book_status=='2'?"selected":""}}>না</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-4 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" id="bn_service_book_no" value="{{old('bn_service_book_no',$security->bn_service_book_no)}}" class="form-control" placeholder="" name="bn_service_book_no">
                        </div>
                    </div>
                    <div class="col-md-4 col-12">
                        <div class="form-group">
                            <label for="bn_old_job_salary">পূর্বের কর্মস্থলের কত টাকা বেতন ছিল</label>
                            <input type="text" id="bn_old_job_salary" value="{{old('bn_old_job_salary',$security->bn_old_job_salary)}}" class="form-control" placeholder="" name="bn_old_job_salary">
                        </div>
                    </div>
                    <div class="col-md-4 col-12">
                        <div class="form-group">
                            <label for="bn_old_job_last_desig">পূর্বের কর্মস্থলে সর্বশেষ পদবী কি ছিলো</label>
                            <input type="text" id="bn_old_job_last_desig" value="{{old('bn_old_job_last_desig',$security->bn_old_job_last_desig)}}" class="form-control" placeholder="" name="bn_old_job_last_desig">
                        </div>
                    </div>
                    <div class="col-md-4 col-12">
                        <div class="form-group">
                            <label for="bn_old_job_experience">পূর্বের কর্মস্থলের মোট চাকুরীর বয়স কত</label>
                            <input type="text" id="bn_old_job_experience" value="{{old('bn_old_job_experience',$security->bn_old_job_experience)}}" class="form-control" placeholder="" name="bn_old_job_experience">
                        </div>
                    </div>
                    <div class="col-md-4 col-12">
                        <div class="form-group">
                            <label for="bn_new_job_transportation">বর্তমান কর্মস্থল হতে আপনার বাসার যাতায়াতের মাধ্যম কি</label>
                            <input type="text" id="bn_new_job_transportation" value="{{old('bn_new_job_transportation',$security->bn_new_job_transportation)}}" class="form-control" placeholder="" name="bn_new_job_transportation">
                        </div>
                    </div>
                    <div class="col-md-4 col-12">
                        <div class="form-group">
                            <label for="bn_current_living">বর্তমান ঠিকানায় কার কার সাথে বসবাস করছেন</label>
                            <input type="text" id="bn_current_living" value="{{old('bn_current_living',$security->bn_current_living)}}" class="form-control" placeholder="" name="bn_current_living">
                        </div>
                    </div>
                    <div class="col-md-4 col-12">
                        <div class="form-group">
                            <label for="bn_total_member">পরিবার এর সদস্য সংখ্যা কত</label>
                            <input type="text" id="bn_total_member" value="{{old('bn_total_member',$security->bn_total_member)}}" class="form-control" placeholder="" name="bn_total_member">
                        </div>
                    </div>
                    <div class="col-md-4 col-12">
                        <div class="form-group">
                            <label for="bn_mobile_no">মোবাইল নং (যদি থাকে)</label>
                            <input type="text" id="bn_mobile_no" value="{{old('bn_mobile_no',$security->bn_mobile_no)}}" class="form-control" placeholder="" name="bn_mobile_no">
                        </div>
                    </div>
                    <div class="col-md-4 col-12">
                        <div class="form-group">
                            <label for="bn_solvent_person">পরিবার এ উপার্জনকারী কত জন</label>
                            <input type="text" id="bn_solvent_person" value="{{old('bn_solvent_person',$security->bn_solvent_person)}}" class="form-control" placeholder="" name="bn_solvent_person">
                        </div>
                    </div>
                    <div class="col-md-4 col-12">
                        <div class="form-group">
                            ...
                            <select id="bn_sim_card_reg_status" class="form-control" name="bn_sim_card_reg_status">
                                <option value="">নির্বাচন করুন</option>
                                <option value="1" {{ $security->bn_sim_card_reg_status=='1'?"selected":""}}>হা</option>
                                <option value="2" {{ $security->bn_sim_card_reg_status=='2'?"selected":""}}>না</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-12 col-12">
                        <div class="form-group">
                            ...
                            <select id="bn_case_filed_status" class="form-control" name="bn_case_filed_status">
                                <option value="">নির্বাচন করুন</option>
                                <option value="1" {{ $security->bn_case_filed_status=='1'?"selected":""}}>হা</option>
                                <option value="2" {{ $security->bn_case_filed_status=='2'?"selected":""}}>না</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-4 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" id="bn_old_job_officer_name" value="{{old('bn_old_job_officer_name',$security->bn_old_job_officer_name)}}" class="form-control" placeholder="" name="bn_old_job_officer_name">
                        </div>
                    </div>
                    <div class="col-md-4 col-12">
                        <div class="form-group">
                            <label for="bn_applicants_name">পূর্বের কর্মস্থলের কর্মকর্তার মোবাইল নং</label>
                            <input type="text" id="bn_old_job_officer_mobile" value="{{old('bn_old_job_officer_mobile',$security->bn_old_job_officer_mobile)}}" class="form-control" placeholder="" name="bn_old_job_officer_mobile">
                        </div>
                    </div>
                    <div class="col-md-4 col-12">
                        <div class="form-group">
                            <label for="bn_applicants_name">পূর্বের কর্মস্থলের কর্মকর্তার পদবি</label>
                            <input type="text" id="bn_old_job_officer_post" value="{{old('bn_old_job_officer_post',$security->bn_old_job_officer_post)}}" class="form-control" placeholder="" name="bn_old_job_officer_post">
                        </div>
                    </div>
                </div>
                <div class="row mt-2">
                ...
                <div class="row">
                    <div class="col-md-3 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" id="bn_identifier_name1" value="{{old('bn_identifier_name1',$security->bn_identifier_name1)}}" class="form-control" placeholder="নাম" name="bn_identifier_name1">
                        </div>
                    </div>
                    <div class="col-md-3 col-12">
                        <div class="form-group">
                            <label for="bn_identifier_occupation1">পেশা</label>
                            <input type="text" id="bn_identifier_occupation1" value="{{old('bn_identifier_occupation1',$security->bn_identifier_occupation1)}}" class="form-control" placeholder="পেশা" name="bn_identifier_occupation1">
                        </div>
                    </div>
                    <div class="col-md-3 col-12">
                        <div class="form-group">
                            <label for="bn_identifier_address1">ঠিকানা</label>
                            <input type="text" id="bn_identifier_address1" value="{{old('bn_identifier_address1',$security->bn_identifier_address1)}}" class="form-control" placeholder="ঠিকানা" name="bn_identifier_address1">
                        </div>
                    </div>
                    <div class="col-md-3 col-12">
                        <div class="form-group">
                            <label for="bn_identifier_phone1">ফোন নং</label>
                            <input type="text" id="bn_identifier_phone1" value="{{old('bn_identifier_phone1',$security->bn_identifier_phone1)}}" class="form-control" placeholder="ফোন নং" name="bn_identifier_phone1">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-3 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" id="bn_identifier_name2" value="{{old('bn_identifier_name2',$security->bn_identifier_name2)}}" class="form-control" placeholder="নাম" name="bn_identifier_name2">
                        </div>
                    </div>
                    <div class="col-md-3 col-12">
                        <div class="form-group">
                            <label for="bn_identifier_occupation2">পেশা</label>
                            <input type="text" id="bn_identifier_occupation2" value="{{old('bn_identifier_occupation2',$security->bn_identifier_occupation2)}}" class="form-control" placeholder="পেশা" name="bn_identifier_occupation2">
                        </div>
                    </div>
                    <div class="col-md-3 col-12">
                        <div class="form-group">
                            <label for="bn_identifier_address2">ঠিকানা</label>
                            <input type="text" id="bn_identifier_address2" value="{{old('bn_identifier_address2',$security->bn_identifier_address2)}}" class="form-control" placeholder="ঠিকানা" name="bn_identifier_address2">
                        </div>
                    </div>
                    <div class="col-md-3 col-12">
                        <div class="form-group">
                            <label for="bn_identifier_phone2">ফোন নং</label>
                            <input type="text" id="bn_identifier_phone2" value="{{old('bn_identifier_phone2',$security->bn_identifier_phone2)}}" class="form-control" placeholder="ফোন নং" name="bn_identifier_phone2">
                        </div>
                    </div>
                </div>
                <div class="row">
