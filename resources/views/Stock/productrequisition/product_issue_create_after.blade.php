                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-select employee_id select2" id="employee_id"
                                                name="employee_id">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-select company_id select2" id="company_id"
                                                name="company_id">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input required class="form-control datepicker" type="text" name="issue_date"
                                                id="issue_date" placeholder="dd/mm/yyy">
                                        ...
                                        <table class="table table-bordered mb-0 table-striped">
                                            <thead>
                                                <tr class="text-center">
                                                    ...
                                                    <th scope="col">{{ __('Return Size') }}</th>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <input class="form-control text-center" type="text"
                                                                name="deposite_product_qty[]" value="0"
                                                                placeholder="Product Qty">
                                                        </td>
                                                        <td>
                                                            <select name="deposite_type[]"
                                                        ...
                                                        <td>
                                                            <select class="form-select size_id" id="deposite_size_id"
                                                                name="deposite_size_id[]">
                                                            ...
                                                            @if ($errors->has('size_id'))
                                                                <span class="text-danger">
                                                                    {{ $errors->first('size_id') }}</span>
                                                            @endif
                                                        </td>
                                                        <td>
                                                            <select required class="form-select product_id" id="product_id"
                                                                name="product_id[]">
                                                                <option value="">Select Product</option>
                                                                @forelse ($product as $pr)
                                                                    <option value="{{ $pr->id }}"
                                                                        {{ old('product_id', $pe->id) == $pr->id ? 'selected' : '' }}>
                                                                        {{ $pr->product_name }}</option>
                                                                @empty
                                                                @endforelse
                                                            </select>
                                                        ...
                                                        <td>
                                                            <select class="form-select size_id" id="size_id"
                                                                name="size_id[]">
                                                                <option value="">Select Size</option>
                                                                @forelse ($size as $s)
                                                                    <option value="{{ $s->id }}">
                                                        ...
                                                        <td><input required class="form-control text-center" type="text"
                                                                name="product_qty[]" value="1"
                                                                placeholder="Product Qty"></td>
                                                        <td>
                                                            <select name="type[]"
                                                                class="form-control @error('type') is-invalid @enderror"
                                                                id="type">
                                                        ...
                                                        <td>
                                                            <span onClick='removeRow(this);'
                                                                class="delete-row text-danger"><i
