                                        ...
                                        <tr id="repeater_less" style="text-align: center;">
                                            @foreach ($invLess as $invl)
                                                <tr style="text-align: center;">
                                                    ...
                                                    <td colspan="7"><input class="form-control text-center" type="text" placeholder="Exaple: Add/Less: 01 duty Receptionist on 17-18/07/2023" name="add_description[]" value="{{$invl->description}}"></td>
