        ...
        <div class="col-12">
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                        <form method="post" action="{{route('southBanglaInvoice.update',[encryptor('encrypt',$inv->id),'role' =>currentUser()])}}" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                            <input type="hidden" name="zone_id" value="{{$inv->zone_id}}" id="zone_id">
                            <div class="row p-2">
                                ...
                                <div class="col-lg-4 mt-2">
                                    ...
                                    <input required class="form-control start_date" type="date" onchange="getDivideBy(this);" name="start_date" value="{{$inv->start_date}}" placeholder="Start Date">
                                </div>
                                <div class="col-lg-4 mt-2">
                                ...
                                <div class="col-lg-4 mt-2">
                                    ...
                                    <input class="form-control" type="date" name="bill_date" value="{{$inv->bill_date}}" required>
                                </div>
                                <div class="col-lg-4 mt-2">
                            ...
                            <div class="row mt-5 table-responsive-sm">
                                <table class="table table-bordered" width="100%" cellspacing="0">
                                    ...
                                    <tbody id="inv-repeat">
                                        @forelse ($invSouthBanglaDetail as $d)
                                            <tr style="text-align: center;">
                                                <th>
                                                    <input type="text" class="form-control" onblur="getInvoiceData(this)" value="{{$d->employee?->admission_id_no}}" placeholder="employee ID">
                                                    <div class="employee_data" style="color:green;font-size:14px;"></div>
                                                    <input type="hidden" class="form-control employee_id" name="employee_id[]" value="{{$d->employee_id}}">
                                                </th>
                                                <td>
                                                    <input type="text" class="form-control text-center job_post" value="{{$d->jobpost?->name}}" placeholder="designation" readonly>
                                                    <input type="hidden" class="form-control text-center job_post_id" name="job_post_id[]" value="{{$d->job_post_id}}">
                                                    <input type="hidden" class="form-control text-center pay_rate" name="rate[]" value="{{$d->rate}}">
                                                    <input type="hidden" class="form-control text-center service_rate" name="service[]" value="{{$d->service}}">
                                                    <input type="hidden" class="form-control text-center divide_by" onkeyup="reCalculateInvoice(this)" name="divide_by[]" value="{{$d->divide_by}}">
                                                </td>
                                                <td><input type="text" class="form-control text-center duty_day" onkeyup="reCalculateInvoice(this)" name="duty_day[]" value="{{$d->duty_day}}" placeholder="duty"></td>
                                                <td><input type="text" class="form-control total text-center net_payment_amount" name="net_payment_amount[]" value="{{$d->net_payment_amount}}" readonly></td>
                                                <td><input type="text" class="form-control total text-center net_service_amount" name="net_service_amount[]" value="{{$d->net_service_amount}}" readonly></td>
                                                <td><input type="text" class="form-control total text-center total_amounts" name="total_amounts[]" value="{{$d->total_amounts}}" readonly></td>
                                                <td><input type="text" class="form-control total text-center remarks" name="remarks[]" value="{{$d->remarks}}"></td>
                                    ...
                                    <tfoot>
                                        <tr style="text-align: center;">
                                            ...
                                            <td><input type="text" class="form-control text-center net_payment" name="net_payment" value="{{$invSouthBangla->net_payment}}" readonly></td>
                                            <td><input type="text" class="form-control text-center net_service" name="net_service" value="{{$invSouthBangla->net_service}}" readonly></td>
                                            <td><input type="text" class="form-control total_with_service text-center" name="total" value="{{$invSouthBangla->total}}" readonly></td>
                                            <td></td>
                                            <td style="text-align: center;"></td>
                                        </tr>
                                        <tr style="text-align: center;">
                                            <th colspan="3">Vat (<span class="vat_percent">{{$invSouthBangla->vat}}</span> %)</th>
                                            <td></td>
                                            <td><input type="text" class="form-control text-center vat_taka" name="vat_taka" value="{{$invSouthBangla->vat_taka}}" readonly></td>
                                            <td></td>
                                            <td></td>
                                            <td></td>
                                        </tr>
                                        <tr style="text-align: center;">
                                            ...
                                            <td></td>
                                            <td><input type="text" class="form-control text-center grand_total" name="grand_total" value="{{$invSouthBangla->grand_total}}" readonly></td>
                                            <td></td>
                                            <td></td>
                                            <td></td>
                                        </tr>
