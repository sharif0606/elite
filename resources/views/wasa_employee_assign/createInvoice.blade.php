                ...
                <div class="card-content">
                    <div class="card-body">
                        ...
                        {{--  <form method="post" action="{{route('WasaInviceStore',[encryptor('encrypt',$empasin?->id)])}}" enctype="multipart/form-data">  --}}
                            @csrf
                            @method('POST')
                            <input type="hidden" name="zone_id" id="zone_id" value="{{$branch?->zone_id ?? $customer->zone_id}}">
                            <div class="row p-2 mt-4">
                                ...
                                <div class="col-lg-3 mt-2 d-none">
                                    ...
                                    <input class="form-control" type="date" name="start_date" value="{{ $empasin->start_date }}">
                                </div>
                                <div class="col-lg-3 mt-2 d-none">
                                    <label for=""><b>End Date</b></label>
                                    <input class="form-control" type="date" name="end_date" value="{{ $empasin->end_date }}">
                                </div>
                                <div class="col-lg-6 mt-2">
                                    <label for=""><b>Header Note</b></label>
                                    <textarea class="form-control" name="header_note" id="" cols="30" rows="3" placeholder="Please enter Footer Note">The payment may please be made in Cheques/Drafts/Cash in favor of "Elite Security Services Limited" by the 1st week of each month.
                                    </textarea>
                                </div>
                                <div class="col-lg-6 mt-2">
                                    <label for=""><b>Footer Note</b></label>
                                    <textarea class="form-control" name="footer_note" id="" cols="30" rows="3" placeholder="Please enter Footer Note">The payment may please be made in Cheques/Drafts/Cash in favor of "Elite Security Services Limited" by the 1st week of each month.
                                    </textarea>
                                </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered mb-0">
                                        ...
                                        <tfoot>
                                            ...
                                            <tr style="text-align: center;">
                                                <td></td>
                                                <th colspan="8">Add: Commission {{ $empasin->add_commission }}%</th>
                                                <td>
                                            ...
                                            <tr style="text-align: center;">
                                                <td></td>
                                                <th colspan="8">(<span class="vat_percent">{{ $empasin->vat_on_commission }}</span> %) VAT + (<span class="vat_percent">{{ $empasin->ait_on_commission }}</span> %)AIT = {{ $empasin->vat_on_commission+$empasin->ait_on_commission }}% Commision</th>
                                                <td>
                                            ...
                                            <tr style="text-align: center;">
                                                <td></td>
                                                <th colspan="8">(<span class="vat_percent">{{ $empasin->vat_on_subtotal }}</span> %) VAT on Sub Total</th>
                                            ...
                                            <tr style="text-align: center;">
                                                <td></td>
                                                <th colspan="8">(<span class="vat_percent">{{ $empasin->ait_on_subtotal }}</span> %) AIT on Sub Total</th>
                                                <td>
