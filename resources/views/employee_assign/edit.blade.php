            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            <form method="post"
                                action="{{ route('employee_assign.update', [encryptor('encrypt', $empasin->id), 'role' => currentUser()]) }}"
                                            ...
                                            <tbody id="empasinassing">
                                                @if ($empasin->details)
                                                    @foreach ($empasin->details as $d)
                                                        <tr>
                                                            <td>
                                                                <select class="form-select atm_id" id="atm_id"
                                                                    name="atm_id[]">
                                                                    <option value="0">Select Atm</option>
                                                                    @forelse ($atm as $a)
                                                                        <option value="{{ $a->id }}"
                                                                            {{ $d->atm_id == $a->id ? 'selected' : '' }}>
                                                                            {{ $a->atm }}</option>
                                                                    @empty
                                                                    @endforelse
                                                                </select>
                                                            ...
                                                            <td>
                                                                <select class="form-select job_post_id"
                                                            ...
                                                            <td><input class="form-control" type="text" name="qty[]"
                                                                    value="{{ $d->qty }}" placeholder="qty" required>
                                                            </td>
                                                            ...
                                                            <td><input class="form-control" type="date" name="end_date[]"
                                                                    value="{{ $d->end_date }}" placeholder="End Date">
                                                            </td>
                                                            <td>
                                                                <select name="hours[]"
