                                    ...
                                    <table class="table table-bordered mb-0 table-striped">
                                        ...
                                        <tbody id="empassign">
                                            ...
                                            <tr>
                                                ...
                                                <td><input class="form-control" type="text" name="agency_com[]" value="{{ $detail->agency_com }}"></td>
            ...
            var row = $(`
                        <tr class="new_rows">
                            ...
                            <td><input class="form-control" type="text" name="agency_com[]"
                                    value="0" placeholder="Agency Commission" required></td>
