...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('salary_sheet_details', function (Blueprint $table) {
            ...
            $table->decimal('deduction_fine',10,2)->default(0);
            $table->decimal('deduction_mobilebill',10,2)->default(0);
            $table->decimal('deduction_loan',10,2)->default(0);
            $table->decimal('deduction_long_loan',10,2)->default(0);
            $table->decimal('deduction_cloth',10,2)->default(0);
            $table->decimal('deduction_jacket',10,2)->default(0);
            $table->decimal('deduction_hr',10,2)->default(0);
            $table->decimal('deduction_traningcost',10,2)->default(0);
            $table->decimal('deduction_c_f',10,2)->default(0);
            $table->decimal('deduction_medical',10,2)->default(0);
            $table->decimal('deduction_ins',10,2)->default(0);
            $table->decimal('deduction_p_f',10,2)->default(0);
            $table->decimal('deduction_revenue_stamp',10,2)->default(0);
            $table->decimal('deduction_total',10,2)->default(0);
            $table->decimal('net_salary',10,2)->default(0);
            $table->decimal('sing_of_ind',10,2)->default(0);
            $table->decimal('remark',10,2)->default(0);
