...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('islami_bank_emp_assigns', function (Blueprint $table) {
            $table->id();
            ...
            $table->decimal('sub_total_salary', 10, 2)->nullable()->default(0);
    ...
    {
        Schema::dropIfExists('islami_bank_emp_assigns');
    }
};