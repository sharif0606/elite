...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('invoice_generate_details', function (Blueprint $table) {
             ...
             $table->string('bonus_rate')->nullable()->after('bonus_type'); // e.g., 'fixed' or 'percentage'
             $table->decimal('bonus_amount', 10, 2)->nullable()->after('bonus_rate'); // Store bonus amount
    ...
    {
        Schema::table('invoice_generate_details', function (Blueprint $table) {
            $table->dropColumn(['bonus_type','bonus_rate', 'bonus_amount','bonus_for']);
        });
    }
};
